      ...
      {mostrarCarrito && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl z-40 max-h-[85vh] overflow-hidden"
          >
            {/* Header del modal */}
            ...
            <div className="sticky bottom-0 bg-white border-t border-gray-200 p-6">
              <div className="flex gap-3">
                <button
                  ...
                  disabled={estaVacio}
                  className="flex-1 px-4 py-3 border border-gray-300 text-gray-700 font-medium rounded-xl hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Vaciar Carrito
                </button>
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Continuar
                </button>
              </div>
