...
export const BotonMenu = ({ activo = false, onSelect, valor, index }) => {
  ...
  return (
    ...
    >
      <div className={` shadow shadow-blue-200 flex items-center gap-2 rounded-2xl px-3 py-0.5 ${activo ? 'bg-blue-500' : 'bg-blue-200'}`}>
        <Icono size={32} className={` bg-blue-50 p-2 rounded-full ${activo ? 'text-white bg-blue-600' : 'text-gray-700'}`} />
